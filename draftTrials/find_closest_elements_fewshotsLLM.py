...
prompt = prompt_generator.generate_prompt(few_shot_examples=['''assert find_closest_elements([1.0, 2.0, 3.9, 4.0, 5.0, 2.2]) == (3.9, 4.0)\n
...
coverage_data = executor2._execute_input(find_closest_elements)
print(coverage_data)
